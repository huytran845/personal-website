      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
            Please contact me if you'd like to discuss potential opportunities
            for hire. I'm eager to work/connect with new people or clients.
          </p>
        ...
        <form
          action="https://getform.io/f/broynxqa"
          method="POST"
